	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.followers}">
				<li class="fieldcontain">
					<span id="followers-label" class="property-label"><g:message code="user.followers.label" default="Followers" /></span>
					
						<g:each in="${userInstance.followers}" var="f">
						<span class="property-value" aria-labelledby="followers-label"><g:link controller="follower" action="show" id="${f.id}">${f?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="following-label" class="property-label"><g:message code="user.following.label" default="Following" /></span>
						...
						<span class="property-value" aria-labelledby="following-label"><g:link controller="follower" action="show" id="${f.id}">${f?.encodeAsHTML()}</g:link></span>
						</g:each>
